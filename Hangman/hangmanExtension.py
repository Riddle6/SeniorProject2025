...
words = {'Colors':'red orange yellow green blue indigo violet white black brown'.split(),
         'Shapes':'square triangle rectangle circle ellipse rhombus trapezoid chevron pentagon hexagon septagon octoagon'.split(),
...
def playAgain():
    # This function returns True if the player plays again; otherwise it returns false.
