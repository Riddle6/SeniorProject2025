...
def drawBoard(board):
    ...
    tensDigitsLine = '   ' # Initial space for the numbers on the left side of the board
    for i in range(1, 6):
...
def makeMove(board, chests, x, y):
    # Change the board data structure with a sonar device character. Remove treasure chests from the chests lists as they are found.
